...
const ChatDrawer = ({ isOpen, onClose, bookingId, customerId, customerName, senderId, token }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/70 backdrop-blur-sm transition-opacity duration-300">
      ...
      <div className="w-full max-w-md h-full bg-[#0b0f19]/95 backdrop-blur-lg border-l border-white/10 flex flex-col shadow-[0_0_50px_rgba(236,72,153,0.12)] animate-slideLeft text-white animate-fadeIn">
        ...
        <div className="p-5 border-b border-white/10 flex justify-between items-center bg-white/5 relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-white font-extrabold text-base tracking-wide">Chat with {customerName}</h3>
        ...
        <div className="flex-grow overflow-y-auto p-5 space-y-4 scrollbar-thin scrollbar-thumb-white/10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900/40 via-slate-950/20 to-black/20">
          {messages.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full text-center p-6 text-gray-400">
              ...
              <p className="text-xs text-gray-500 mt-1 max-w-[200px]">Message {customerName} to coordinate styling preferences or updates!</p>
            </div>
          )}
