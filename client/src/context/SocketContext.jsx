...
// Global WebSocket context banaya hai taaki client me sockets reuse ho sake
...
export const SocketContextProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    // transports array me websocket preferred and polling fallback default diya hai
